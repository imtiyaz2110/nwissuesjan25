...
import com.nwissuesjan25.wmstudio.service.WMSTUDIOQueryExecutorService;
...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/getemps", method = RequestMethod.GET)
    public Page<Object> executeGetemps(@RequestParam(value = "empid2", required = false) java.lang.Integer empid2, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query getemps");
        Page<Object> result = queryService.executeGetemps(pageable, empid2);
